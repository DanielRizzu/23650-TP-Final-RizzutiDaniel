...
public class AccountService {
    ...
    //Obtiene una lista de cuentas bancarias y devuelve Lista de objetos AccountDto que representan las cuentas..
    ...
    //Crea nueva cuenta bancaria asociada a un usuario..
    @Transactional
    ...
    //Actualiza la información de una cuenta bancaria que existe..
    ...
    private BigDecimal performTransaction(BigDecimal amount, Long idOrigin) {
        ...
        //veo si hay fondos suficientes.

        if (account.getBalance().add(amount).compareTo(BigDecimal.ZERO) >= 0) {

            //actualizo el saldo de la cuenta con el nuevo monto.
